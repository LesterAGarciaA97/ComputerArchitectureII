...
HD_PWD='/home/axel/Documentos/laboratorios-arqui-2/Vivado/Lab 3 - EmisorReceptor/Lab 3 - EmisorReceptor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codigo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codigo.tcl -notrace
