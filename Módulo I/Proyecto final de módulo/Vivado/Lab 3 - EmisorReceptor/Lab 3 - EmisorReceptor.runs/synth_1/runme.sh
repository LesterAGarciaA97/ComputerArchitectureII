...
HD_PWD='/home/axel/Documentos/laboratorios-arqui-2/Vivado/Lab 3 - EmisorReceptor/Lab 3 - EmisorReceptor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codigo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codigo.tcl
