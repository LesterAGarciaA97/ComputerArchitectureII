...
HD_PWD='/home/axel/Documentos/Proyectos de Arqui 2/Vivado/Lab 2/Lab 2 - Ingresar datos/Lab 2 - Ingresar datos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ingreso.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ingreso.tcl
