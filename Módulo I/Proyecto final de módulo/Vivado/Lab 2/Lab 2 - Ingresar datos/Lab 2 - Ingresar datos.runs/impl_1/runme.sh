...
HD_PWD='/home/axel/Documentos/Proyectos de Arqui 2/Vivado/Lab 2/Lab 2 - Ingresar datos/Lab 2 - Ingresar datos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ingreso.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ingreso.tcl -notrace
